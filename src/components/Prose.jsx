  ...
  return (
    <Component
      className={clsx(
        ...
        // Responsive typography — scales up on larger viewports
        ...
        // Text styles
        'prose-p:my-6 prose-p:leading-relaxed prose-p:text-zinc-600 dark:prose-p:text-zinc-400',
        ...
        // Code blocks with subtle border and better padding
        'prose-pre:mt-6 prose-pre:rounded-xl prose-pre:border prose-pre:border-zinc-200/60',
        'prose-pre:bg-zinc-50 prose-pre:px-5 prose-pre:py-5 prose-pre:text-sm',
        'prose-pre:leading-relaxed prose-pre:shadow-xs',
        'dark:prose-pre:bg-zinc-800/80 dark:prose-pre:border-zinc-700/30 dark:prose-pre:shadow-zinc-900/20',
        ...
        // Horizontal rules
        'prose-hr:my-12 prose-hr:border-zinc-200 dark:prose-hr:border-zinc-700/40',
