      ...
      <div className="my-8 rounded-xl bg-amber-50 border border-amber-200 p-4 shadow-xs dark:bg-amber-900/10 dark:border-amber-700/30">
        <div className="flex items-center">
          <div className="shrink-0">
            <svg className="h-5 w-5 text-amber-600 dark:text-amber-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fillRule="evenodd" d="M8.485 2.495c.673-1.167 2.357-1.167 3.03 0l6.28 10.875c.673 1.167-.17 2.625-1.516 2.625H3.72c-1.347 0-2.189-1.458-1.515-2.625L8.485 2.495zM10 5a.75.75 0 01.75.75v4.5a.75.75 0 01-1.5 0v-4.5A.75.75 0 0110 5zm0 10a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
            </svg>
          </div>
          <div className="ml-3">
            <h3 className="text-sm font-medium text-amber-800 dark:text-amber-600">Failed to load image</h3>
  ...
  if (variant === 'diagram') {
    return (
      <div className="my-8">
        ...
        {caption && (
          <p className="mt-2 text-sm text-zinc-600 text-center italic dark:text-zinc-400">{caption}</p>
        )}
      </div>
    )
  }
